...
-- Autor(es) ..............: Carlos Eduardo Rodrigues, Danilo César Tertuliano Melo
-- 
...
-- 		   => 01 Visao
--
--   04/11/2024 => Criação dos perfis e dos usuários que estão descritos no enunciado;
-- 				   Remoção do uso do @'localhost', já que o enunciado não solicita tal restrição;
-- -----------------------------------------------------------------
